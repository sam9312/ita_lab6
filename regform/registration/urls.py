...
urlpatterns = [ 
				...
				url(r'^sy/$', useradmin_views.scotlandyard),
				...
				url(r'^civil/results/$', useradmin_views.search, kwargs={'sig_name': 'civil'}),
				...
				url(r'^civil/selected/$', useradmin_views.selected, kwargs={'sig_name': 'civil'}),
				...
				url(r'^civil/results/detail/(?P<pk>\d+)$', useradmin_views.detailreply, kwargs={'sig_name': 'civil'}),
